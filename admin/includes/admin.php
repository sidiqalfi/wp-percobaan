...
require_once ABSPATH . 'admin/includes/privacy-tools.php';

/** WordPress Privacy List Table classes. */
// Previously in admin/includes/user.php. Need to be loaded for backward compatibility.
require_once ABSPATH . 'admin/includes/class-wp-privacy-requests-table.php';
require_once ABSPATH . 'admin/includes/class-wp-privacy-data-export-requests-list-table.php';
require_once ABSPATH . 'admin/includes/class-wp-privacy-data-removal-requests-list-table.php';
