...
function wp_logout_url( $redirect = '' ) {
	...
	$logout_url = add_query_arg( $args, site_url( 'newlogin.php?action=logout', 'login' ) );
...
function wp_registration_url() {
	 ...
	 */
	return apply_filters( 'register_url', site_url( 'newlogin.php?action=register', 'login' ) );
}
...
function wp_login_form( $args = array() ) {
	...
	$form = '
		<form name="' . $args['form_id'] . '" id="' . $args['form_id'] . '" action="' . esc_url( site_url( 'newlogin.php', 'login_post' ) ) . '" method="post">
			' . $login_form_top . '
...
function wp_lostpassword_url( $redirect = '' ) {
	...
	if ( is_multisite() ) {
		...
		$wp_login_path = $blog_details->path . 'newlogin.php';
	} else {
		$wp_login_path = 'newlogin.php';
	}
